    ...
    <div className="w-full">
      <header className="mb-6 border-b pb-4">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-mushdark">{title}</h2>
          <Button variant="outline" size="sm" className="flex items-center gap-2 rounded-full border-mushgray/30">
            <Filter size={14} />
            Filtrer
          </Button>
        </div>
      ...
      <footer className="mt-8 pt-4 border-t flex justify-between">
        <Button variant="outline" className="text-mushgray border-mushgray/30 rounded-full">Précédent</Button>
        <Button className="bg-mushprimary hover:bg-mushprimary/90 text-white rounded-full">Suivant</Button>
      </footer>
    </div>
  );
};
